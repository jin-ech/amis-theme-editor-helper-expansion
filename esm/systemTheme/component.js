            ...
            enhance: {
                ...
                leftIcon: {
                    default: {
                        ...
                        body: {
                            'icon': '\'<svg viewBox="0 0 12 2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="icon icon-minus"><g id="minus" fill="currentColor" fill-rule="nonzero"><polygon id="path-1" points="0 1.6 0 0.4 12 0.4 12 1.6"></polygon></g></svg>\'',
                            'size': {
                ...
                rightIcon: {
                    default: {
                        ...
                        body: {
                            'icon': '\'<svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" class="icon  icon-plus"><path d="M6.6 6.6V12H5.4V6.6H0V5.4h5.4V0h1.2v5.4H12v1.2z" fill="currentColor" fill-rule="nonzero"></path></svg>\'',
                            'size': {
                                height: 'var(--sizes-size-7)',
                                width: 'var(--sizes-size-7)'
                            },
    ...
    collapse: {
        base: {
            ...
            icon: {
                ...
                token: '--collapse-icon-',
                body: {
                    icon: '\'<svg viewBox="0 0 99 176" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g transform="translate(-0.132812, 0.304688)" fill="currentColor" fill-rule="nonzero"><path d="M95.6353697,79.4031346 C95.3433678,79.1111326 95.037575,78.8417152 94.7219891,78.5906854 L19.819373,3.29993262 C15.6492004,-0.870040234 8.88818437,-0.870040234 4.71821172,3.29993262 C0.548238867,7.47010527 0.548238867,14.2309215 4.71821172,18.4010939 L72.9329621,87.0041811 L3.25320488,156.617783 C-0.916767969,160.787956 -0.916767969,167.548772 3.25320488,171.719144 C7.42317773,175.889117 14.1841937,175.889117 18.3543662,171.719144 L94.7211895,95.4180764 C95.0369754,95.1668467 95.342968,94.8976293 95.6351697,94.6054273 C97.7329475,92.5076496 98.7744412,89.7539166 98.7615739,87.0043809 C98.7746414,84.2544453 97.7331475,81.5009123 95.6353697,79.4031346 Z" id="路径"></path></g></svg>\'',
    ...
    pick: {
        base: {
            ...
            body: {
                ...
                'bgColor': 'var(--colors-neutral-line-11)',
                'value-font': {
        ...
        base: {
            ...
            badge: {
                ...
                body: {
                    ...
                    'onComplete-color': 'var(--colors-neutral-text-11)',
                    'onComplete-bg-color': 'var(--colors-neutral-fill-3)',
    ...
    combo: {
        ...
        multi: {
            ...
            body: {
                ...
                'addBtn-bg-color': 'var(--colors-brand-5)',
                'addBtn-height': 'var(--sizes-base-13)',
                'addBtn-padding-and-margin': {
                    paddingTop: 'var(--sizes-size-3)',
                    paddingRight: 'var(--sizes-size-5)',
                    paddingBottom: 'var(--sizes-size-3)',
                    paddingLeft: 'var(--sizes-size-5)'
                },
                'addBtn-hover-color': 'var(--colors-neutral-text-11)',
                'addBtn-hover-bg-color': 'var(--colors-brand-6)',
                'addBtn-active-color': 'var(--colors-neutral-text-11)',
